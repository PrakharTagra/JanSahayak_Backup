                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center justify-between mt-4 pt-4 border-t border-white/5">
                      ...
                      <div className="flex gap-2 items-center">
                        ...
                        {/* Google Maps button — only shown when coordinates exist */}
                        {mapsUrl(post.geoLocation) && (
                          <a
                            href={mapsUrl(post.geoLocation)}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-[10px] font-mono-gov text-blue-400 hover:text-blue-300 transition px-3 py-1.5 border border-blue-700/40 hover:border-blue-600/60 bg-blue-900/20 hover:bg-blue-900/30 flex items-center gap-1.5"
                          >
                            📍 View on Map
                          </a>
                        )}
